import{l as n}from"./utils-DXdLGH_B.js";document.addEventListener("DOMContentLoaded",()=>{const e=localStorage.getItem("watchlist");e&&JSON.parse(e).forEach(i=>{t(i)})});function t(e){const s=document.createElement("div");s.classList.add("card"),s.innerHTML=`<span id="closeBtn" class="close">&times;</span><h2>${e.name}</h2>
